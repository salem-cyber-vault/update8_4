...
const API_KEYS = {
  ...
  SHODAN: process.env.NEXT_PUBLIC_SHODAN_API_KEY || "***REMOVED***",
  VIRUSTOTAL:
    process.env.NEXT_PUBLIC_VIRUSTOTAL_API_KEY || "***REMOVED***",
  ABUSEIPDB:
    process.env.NEXT_PUBLIC_ABUSEIPDB_API_KEY || "***REMOVED***",
